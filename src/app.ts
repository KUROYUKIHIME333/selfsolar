...
export const buildApp = async (): Promise<FastifyInstance> => {
  const app = fastify({
    ...
    ajv: {
      customOptions: {
        removeAdditional:
          process.env.NODE_ENV !== "production" ? "all" : undefined,
      },
    },
  });
  ...
  await app.register(swagger, {
    openapi: {
      info: {
        title: "SelfSolar API",
        description:
          "API de dimensionnement photovoltaïque conforme aux normes NFC 15-100, IEC 61215, IEC 62109",
        version: "2.0.0",
        contact: {
      ...
      tags: [
        {
          name: "photovoltaique",
          description: "Dimensionnement installations solaires",
        },
