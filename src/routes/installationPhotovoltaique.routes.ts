...
export const installationPhotovoltaiqueRoutes = async (
  ...
  //   schema: {
  //     description:
  //       "Dimensionnement complet installation photovoltaïque selon normes NFC 15-100, IEC 61215",
  ...
  //         modeleBatterie: {
  //           type: "object",
  //           description: "Caractéristiques de la batterie choisie (l'unité)",
  //           properties: {
  //             v: {
  //               type: "number",
  //               default: 12,
  //               description: "Tension d'un module de batterie",
  //             },
  //             ah: {
  //               type: "number",
  //               description: "capacité d'un module de batterie",
  //             },
  //           },
  //         },
